...
ds['zhe'] = ds['sentence'].str.count('ژ')/ds['sentence'].str.len()
ds['pe'] = ds['sentence'].str.count('پ')/ds['sentence'].str.len()
ds['ein'] = ds['sentence'].str.count('ع')/ds['sentence'].str.len()
ds['lam'] = ds['sentence'].str.count('ل')/ds['sentence'].str.len()
